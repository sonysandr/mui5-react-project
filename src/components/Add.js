  ...
  return (
    <>
      ...
      <Modal
        ...
        // instead we can have our own styled modal and replace by <StyledModal/> ie; const StyledModal = styled(Modal)({ display:"flex",alignItems:"center,justifyContent:"center"})
        sx={{
          alignItems: "center",
          display: "flex",
